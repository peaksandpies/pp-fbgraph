...
var graphVersion = '3.3'
var oauthDialogUrl = 'https://www.facebook.com/v2.0/dialog/oauth?'
var oauthDialogUrlMobile = 'https://m.facebook.com/v2.0/dialog/oauth?'
var requestOptions = {}
...
Graph.prototype.end = function (res) {
  const cpuUsage = res.headers['x-business-use-case-usage']
  var body = res.body
